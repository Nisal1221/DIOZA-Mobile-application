...
class MenswearPage extends StatefulWidget {
  @override
  _MenswearPageState createState() => _MenswearPageState();
}
...
class _MenswearPageState extends State<MenswearPage> {
  ...
  void uploadDataToFirestore() async {
    ...
    Reference storageRef = FirebaseStorage.instance.ref().child('menswear_images').child(_title);
    ...
    firestore.collection('menswear').doc(_title).set({
      'title': _title,
