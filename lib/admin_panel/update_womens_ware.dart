...
class UpdatewomensPage extends StatefulWidget {
  @override
  _UpdatewomensPageState createState() => _UpdatewomensPageState();
}

class _UpdatewomensPageState extends State<UpdatewomensPage> {
  ...
  void updateDataInFirestore() async {
    ...
    if (_image != null) {
      Reference storageRef = FirebaseStorage.instance.ref().child('womenswear_images').child(_documentName);
      UploadTask uploadTask = storageRef.putFile(_image!);
      TaskSnapshot taskSnapshot = await uploadTask;
      imagePath = await taskSnapshot.ref.getDownloadURL();
    }

    firestore.collection('womenswear').doc(_documentName).update({
      'title': _title,
