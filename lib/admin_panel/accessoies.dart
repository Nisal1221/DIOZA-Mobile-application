...
class _AccessoriesPageState extends State<AccessoriesPage> {
  ...
  void uploadDataToFirestore() async {
    ...
    Reference storageRef = FirebaseStorage.instance.ref().child('accessories_images').child(_title);
    ...
    firestore.collection('accsosseris').doc(_title).set({
      'title': _title,
